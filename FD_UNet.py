...
############################ FD-UNet Based Model ##############################
###############################################################################
def FD_UNet(image_height, image_width, image_channels, first_layer_growth_rate):
    ...
    Outputs = tf.keras.layers.Conv2D(filters=1, kernel_size=(1,1), strides=(1,1), padding='same', activation=None)(Deconvolutional_layer[-1])
